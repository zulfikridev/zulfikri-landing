        ...
        <div className="space-y-8">
          {PROJECTS.map((project, index) => (
            <motion.div
              ...
              className="group relative rounded-2xl bg-slate-900/50 border border-slate-800/60 hover:border-indigo-500/30 transition-all duration-300 overflow-hidden"
            >
              {/* Top accent line */}
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 text-xs font-mono rounded-full bg-slate-800/60 border border-slate-700/40 text-slate-400"
                    >
                      {tech}
                    </span>
                  ))}
