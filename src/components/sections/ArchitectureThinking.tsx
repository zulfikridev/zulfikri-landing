    ...
    <section id="architecture" className="section-padding">
      <div className="container-max">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {ARCHITECTURE_PRINCIPLES.map((principle, index) => (
            <motion.div
              ...
              className="group rounded-2xl p-6 bg-slate-900/50 border border-slate-800/60 hover:border-indigo-500/30 transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="rounded-2xl bg-slate-900/50 border border-slate-800/60 p-8 md:p-10"
        >
          ...
          <div className="flex flex-col items-center gap-0">
            {[
              ...
              },
              {
                ...
                color: "border-slate-500/40 bg-slate-800/40 text-slate-300",
                width: "w-full max-w-sm",
              },
            ].map((layer, i) => (
                ...
                >
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {layer.items.map((item) => (
                      <span
                        key={item}
                        className="text-xs px-2 py-1 rounded-md bg-white/5 font-mono"
                      >
                        {item}
                      </span>
                    ))}
